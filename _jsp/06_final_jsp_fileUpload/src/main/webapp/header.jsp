                ...
                <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                    <ul class="navbar-nav ms-auto navbar-nav-scroll">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-bs-toggle="dropdown" aria-expanded="false">${ses.nick_name }</a>
                            <ul class="dropdown-menu" aria-labelledby="dropdown01">
                                <li><a class="dropdown-item" href="/">${ses.last_login }</a></li>
                                <li><div class="dropdown-divider"></div></li>
                                <li><a class="dropdown-item" href="/">${ses.grade}</a></li>
                                <li><div class="dropdown-divider"></div></li>
                                <li><a class="dropdown-item" href="/mem/modify?em=${ses.email }">${ses.email }</a></li>
                            </ul>
                        </li>
                        </c:if>
                    </ul>
                    ...
                    <span class="nav-item">
                        <a class="btn-outline-sm" href="/mem/logout?em=${ses.email}">LOGOUT</a>
                    </span>
                    </c:if>
